      ...
      <div className="row">
        <div className="col-xs-12 col-sm-7">
          <p>
            ...
            streamer. Tech speaker and content creator. Interested in DevRel,
            ReactJS, video games, and napping with the cat.
          </p>
          <p>
            I have over a decade of experience in the software industry and my
            passion is in helping people make things happen; sometimes that
            means making an app that makes their lives easier, and sometimes it
            means teaching them how to build the app they want to see in the
            world.
          </p>
